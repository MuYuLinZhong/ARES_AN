    ...
    <div className="flex-1 flex flex-col h-screen overflow-y-auto hide-scrollbar bg-[#15202b]">
      ...
      <div className="flex flex-col items-center pt-4 pb-8">
        <div className="w-24 h-24 rounded-full bg-orange-200 p-1 mb-4">
          <img src="https://picsum.photos/seed/alex/150/150" alt="Alex Rivera" className="w-full h-full rounded-full object-cover" />
        </div>
        <h1 className="text-2xl font-bold text-white mb-1">Alex Rivera</h1>
        <p className="text-sm text-slate-400">Admin Profile • alex.r@smartlock.io</p>
      </div>
          ...
          <div className="bg-[#1e2a38] rounded-xl overflow-hidden border border-slate-800 p-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="text-sm font-medium text-slate-200">Online Mode</span>
                <span className="text-xs text-slate-500">Require internet for key auth</span>
              </div>
            </div>
